...
let section_delete_buttons = document.getElementsByName(
  "delete_section_button"
);
let button_show_form_section = document.getElementsByName(
  "button_show_form_section"
);
...
button_show_form_section.forEach((item) => {
  item.addEventListener("click", (e) => {
    ...
    if (user !== "AnonymousUser")
      if (
        document
          .getElementById("section_inside_menu" + item.value)
...
section_delete_buttons.forEach((elem) =>
...
button_update_section.forEach((elem) =>
  elem.addEventListener("click", (e) => {
    e.preventDefault();
  })
);

buttons_add_item.forEach((elem) =>
  elem.addEventListener("click", () => {
    elem.parentElement.parentElement.parentElement.appendChild(
      createAddItemForm(url_ingredients, elem.value).html
    );
  })
);
