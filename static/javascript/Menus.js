...
delete_menus.forEach(elem => elem.addEventListener('click', (e) => {
    e.preventDefault()
    Confirm.open({
        title: 'Salut',
        message: 'Scuze',
...
add_menu_button.addEventListener('click', (e) => {
    ...
    if (user !== "AnonymousUser") {
        if (document.getElementById("Action_owner_form").querySelector('.form_create_review') == null)
        ...
        else if (document.getElementById('Action_owner_form').querySelector('.form_create_review').classList.contains('hide'))
            document.getElementById('Action_owner_form').querySelector('.form_create_review').classList.remove('hide')
        else
            document.getElementById('Action_owner_form').querySelector('.form_create_review').classList.add('hide')
    }
})
